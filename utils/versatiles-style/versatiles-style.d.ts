...
declare class Empty extends StyleBuilder<Empty> {
    readonly name: string;
    defaultFonts: {
        regular: string;
        bold: string;
...
type EmptyOptions = StyleBuilderOptions<Empty>;
type SomeOptions = ColorfulOptions | EclipseOptions | EmptyOptions | GraybeardOptions | NeutrinoOptions;
...
type EmptyBuilder = MakeStyle<Empty, EmptyOptions>;
type SomeBuilder = ColorfulBuilder | EclipseBuilder | EmptyBuilder | GraybeardBuilder | NeutrinoBuilder;
...
declare const empty: EmptyBuilder;
...
type index_d_EmptyBuilder = EmptyBuilder;
type index_d_EmptyOptions = EmptyOptions;
...
declare const index_d_empty: typeof empty;
declare const index_d_graybeard: typeof graybeard;
declare const index_d_neutrino: typeof neutrino;
declare namespace index_d {
  export { type index_d_ColorfulBuilder as ColorfulBuilder, type index_d_ColorfulOptions as ColorfulOptions, type index_d_EclipseBuilder as EclipseBuilder, type index_d_EclipseOptions as EclipseOptions, type index_d_EmptyBuilder as EmptyBuilder, type index_d_EmptyOptions as EmptyOptions, type index_d_GraybeardBuilder as GraybeardBuilder, type index_d_GraybeardOptions as GraybeardOptions, type index_d_MaplibreStyle as MaplibreStyle, type index_d_NeutrinoBuilder as NeutrinoBuilder, type index_d_NeutrinoOptions as NeutrinoOptions, type index_d_RecolorOptions as RecolorOptions, type index_d_SomeBuilder as SomeBuilder, type index_d_SomeOptions as SomeOptions, index_d_colorful as colorful, index_d_eclipse as eclipse, index_d_empty as empty, index_d_graybeard as graybeard, index_d_neutrino as neutrino };
}
...
export { type ColorfulBuilder, type ColorfulOptions, type EclipseBuilder, type EclipseOptions, type EmptyBuilder, type EmptyOptions, type GraybeardBuilder, type GraybeardOptions, type GuessStyleOptions, type MaplibreStyle, type NeutrinoBuilder, type NeutrinoOptions, type RecolorOptions, type SomeBuilder, type SomeOptions, colorful, eclipse, empty, graybeard, guessStyle, neutrino, index_d as styles };
